...
//var containerHight=260;
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      const errorMessage = 'Could not authinacate you, Please try again';
      _showErrorDialog(errorMessage);
    }
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      elevation: 8.0,
      child:AnimatedBuilder(animation: _hightAnimation,builder: (ctx,ch)=>AnimatedContainer(
    duration: Duration(milliseconds: 300),
        ...
        padding: EdgeInsets.all(16.0),child: Form(
        key: _formKey,
